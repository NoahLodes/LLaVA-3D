...
class Open2D3DSGDataset(Dataset):
    ...
    def load_features_disk(self, data_dict):
        ...
        if torch_numpy == '.npy':
            ...
            obj_valid_feature14101410s = torch.from_numpy(np.load(obj_valid_feature_pth))
...
#     scans_r3scan = json.load(open(os.path.join(CONF_PATH_R3SCAN_RAW, "relationships_validation.json")))["scans"]
